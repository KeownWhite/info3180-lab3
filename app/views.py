...
def contact():
    ...
    if request.method == 'POST' and contactform.validate_on_submit():
        send_mail(contactform.name.data,contactform.email.data,contactform.subject.data,contactform.message.data)
        flash('Successfully sent')
        return redirect(url_for('home'))
    else:
        return render_template('contact.html',form=contactform,addtext='Error with sending')
